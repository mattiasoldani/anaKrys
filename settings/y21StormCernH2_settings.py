...
#        calibMapFwd.update({iRun: [lambda x, a, b: a*x+b, [0.1318, -1.874], 'end']})  # w/ nominal beam energies
        calibMapFwd.update({iRun: [lambda x, a, b: a*x+b, [0.1179, -1.403], 'end']})  # w/ simulated direct beam runs
