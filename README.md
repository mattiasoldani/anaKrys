...
Note: all the basic dependencies, as well as the required installation channels and the optional JupyterLab extension dependencies, are listed in the Anaconda environment.yml file &mdash; see the section on environment setup for further details.
